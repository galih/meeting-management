  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .err-circle-outer {
      ...
      background: linear-gradient(135deg, rgba(123,28,28,.08), rgba(201,168,76,.10));
    ...
    .err-circle-inner {
      ...
      display: flex; align-items: center; justify-content: center;
      box-shadow: 0 8px 32px rgba(123,28,28,.30);
    }
    ...
    .err-code {
      ...
      line-height: 1;
      letter-spacing: -.04em;
      background: linear-gradient(135deg, var(--primary) 30%, var(--gold-dark));
...
<body>
  <div class="err-wrap">
    <div class="err-card">
      <div class="err-watermark">404</div>
        ...
        <div class="err-circle-outer">
          <div class="err-circle-inner">
            <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
              ...
              <line x1="8" y1="11" x2="14" y2="11" opacity=".6"/>
            </svg>
          </div>
          <span class="err-badge">404</span>
        </div>
      </div>
      ...
      <p class="err-desc">
        Halaman yang Anda cari tidak ada, sudah dipindahkan, atau alamat URL yang dimasukkan tidak tepat.
      </p>
      ...
      <div class="err-actions">
        ...
        <button onclick="history.back()" class="err-btn err-btn-outline">
