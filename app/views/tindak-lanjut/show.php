...
<div class="row g-3">
  ...
  <div class="col-lg-4">
    ...
    <div class="tl-card mb-3">
      <div class="tl-card-header">
        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="8"/><line x1="12" y1="12" x2="12" y2="16"/></svg>
        Info Tindak Lanjut
      </div>
...
noteInput?.addEventListener('keydown',e=>{ if(e.key==='Enter'&&e.ctrlKey)submitNote(); });
  ...
  btn.addEventListener('click',async()=>{
    ...
    if(d.success){
      ...
      if(!document.querySelector('.tl-note-item'))
        document.getElementById('notes-list').innerHTML='<div class="tl-empty" id="notes-empty"><p>Belum ada catatan progress</p></div>';
    } else {
