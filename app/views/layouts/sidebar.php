    ...
    <div class="collapse navbar-collapse" id="topnav-menu">
      <ul class="navbar-nav me-auto">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle <?= (isActive('/users',$currentUri) || isActive('/departments',$currentUri) || isActive('/recurring',$currentUri) || isActive('/notulen-templates',$currentUri) || isActive('/settings',$currentUri)) ? 'active' : '' ?>"
